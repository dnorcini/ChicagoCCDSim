...
DAMICPhysicsListLivermore::DAMICPhysicsListLivermore() : G4VUserPhysicsList() 
{
    ...
    //XXX our PL uses SetDEDBinning(200), SEtLambdaBinning(200) XXX
...
// Destructor //////////////////////////////////////////////////////////////
DAMICPhysicsListLivermore::~DAMICPhysicsListLivermore() 
{
}

// Construct Particles /////////////////////////////////////////////////////
void DAMICPhysicsListLivermore::ConstructParticle() 
{
...
// construct Bosons://///////////////////////////////////////////////////
void DAMICPhysicsListLivermore::ConstructMyBosons()
{
    // pseudo-particles
...
// construct Leptons://///////////////////////////////////////////////////
void DAMICPhysicsListLivermore::ConstructMyLeptons()
{
    // leptons
...
// construct Hadrons://///////////////////////////////////////////////////
void DAMICPhysicsListLivermore::ConstructMyHadrons()
{
    //  mesons
...
void DAMICPhysicsListLivermore::ConstructMyShortLiveds()
{
...
// Construct Processes //////////////////////////////////////////////////////
void DAMICPhysicsListLivermore::ConstructProcess() 
{
    AddTransportation();
...
// Transportation ///////////////////////////////////////////////////////////
void DAMICPhysicsListLivermore::AddTransportation() 
{
    ...
    while( (*particleIterator)() )
    {
        ...
        {
            pmanager->AddDiscreteProcess(new DAMICMaxTimeCuts());
        }
        // Energy cuts to kill charged (embedded in method) particles:
        pmanager->AddDiscreteProcess(new DAMICMinEkineCuts());
...
void DAMICPhysicsListLivermore::ConstructEM() 
{
...
// Optical Processes ////////////////////////////////////////////////////////
void DAMICPhysicsListLivermore::ConstructOp() 
{
...
void DAMICPhysicsListLivermore::ConstructHad() 
{
    // XXX
    // Elastic models
    ...
    // XXX const G4double theFTFMin1  = 4.0*GeV;
    const G4double theFTFMin1 =    3.0*GeV;
    // XXX const G4double theFTFMax   = 100.0*TeV;
    ...
    while ((*particleIterator)())
    {
        ...
        if (particleName == "pi+") 
        {
            ...
            // XXX we have an extra line: theElasticProcess->RegisterMe( elastic_lhep1 );
...
// Decays ///////////////////////////////////////////////////////////////////
void DAMICPhysicsListLivermore::ConstructGeneral() 
{
    ...
    G4PhysicsListHelper::GetPhysicsListHelper()->RegisterProcess
        (new G4RadioactiveDecayBase(), G4GenericIon::GenericIon());
}

// Cuts /////////////////////////////////////////////////////////////////////
void DAMICPhysicsListLivermore::SetCuts() 
{
    
    if (verboseLevel >1)
    {
        G4cout << "DAMICPhysicsListLivermore::SetCuts:";
    }
