...
DAMICMaxTimeCuts::DAMICMaxTimeCuts(const G4String& aName)
...
DAMICMaxTimeCuts::DAMICMaxTimeCuts(DAMICMaxTimeCuts&)
 : DAMICSpecialCuts()
{
}
 
G4double DAMICMaxTimeCuts::PostStepGetPhysicalInteractionLength(
