...
DAMICMinEkineCuts::DAMICMinEkineCuts(const G4String& aName)
  : DAMICSpecialCuts(aName)
{
    if (verboseLevel>1) 
    {
...
DAMICMinEkineCuts::DAMICMinEkineCuts(DAMICMinEkineCuts&)
  : DAMICSpecialCuts()
{
}

G4double DAMICMinEkineCuts::PostStepGetPhysicalInteractionLength(
